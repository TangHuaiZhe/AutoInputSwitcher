...
/usr/libexec/PlistBuddy -c "Add :ProgramArguments:1 string -n" "${TEMP_PLIST}"
/usr/libexec/PlistBuddy -c "Add :ProgramArguments:2 string -g" "${TEMP_PLIST}"
/usr/libexec/PlistBuddy -c "Add :ProgramArguments:3 string -a" "${TEMP_PLIST}"
/usr/libexec/PlistBuddy -c "Add :ProgramArguments:4 string ${APP_PATH}" "${TEMP_PLIST}"
